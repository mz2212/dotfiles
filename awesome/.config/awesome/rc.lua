...
local APW = require("widget.apw.widget")
-- CPU Monitor: https://github.com/streetturtle/awesome-wm-widgets/tree/master/cpu-widget
local cpu = require("widget.cpu")
-- Scratchpad: https://github.com/notnew/awesome-scratch
local scratch = require("widget.scratch")
-- Battery Monitor: https://github.com/deficient/battery-widget
...
beautiful.init(awful.util.getdir("config") .. "themes/default-mod/theme.lua")
