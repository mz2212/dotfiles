...
local color         = '#1d5' -- foreground color of progessbar
local color_bg      = '#030' -- background color
local color_mute    = '#d51' -- foreground color when muted
local color_bg_mute = '#300' -- background color when muted
...
local pulseaudio = require("widget.apw.pulseaudio")
